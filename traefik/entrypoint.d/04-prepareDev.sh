...
: ${SIMVA_EXTENSIONS_VERSION:="1.2.0"}
: ${JQ_VERSION:="1.7.1"}
: ${EXTERNAL_DOMAIN:="external.test"}
: ${INTERNAL_DOMAIN:="internal.test"}
: ${DNS_SERVERS:=8.8.8.8 8.8.4.4}
: ${SIMVA_EXTENSIONS:="es.e-ucm.simva.keycloak.fullname-attribute-mapper es.e-ucm.simva.keycloak.policy-attribute-mapper es.e-ucm.simva.keycloak.simva-theme-v2"}
